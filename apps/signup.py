...
layout = html.Div(
    [
        ...
        html.Hr(),
        dbc.Alert('Please supply the missing details.', color="danger", id='signup_alert',
                  is_open=False),
        dbc.Row(
            [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    dbc.Input(
                        type="password", id="signup_password", placeholder="Enter a password or you may use your Employee ID"
                    ),
                    width=4,
                ),
            ],
        ...
        dbc.Button('Sign up', color="info", id='singup_signupbtn'),
        dbc.Modal(
            [
